module CsusbSpecHelpers
  def get_current_term
    doc = get_doc("https://acsweb.csusb.edu/schedule/astra/schedule.jsp")
  ...
  def get_class(status)
    ...
    doc = get_doc("https://acsweb.csusb.edu/schedule/astra/class.jsp?quarter=#{term_code}&campus=ALL&crseabbrev=#{abbrev}&cnmbr=&txc=+&Submit=Submit")
